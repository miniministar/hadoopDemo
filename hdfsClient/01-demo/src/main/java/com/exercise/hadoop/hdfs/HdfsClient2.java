...
public class HdfsClient2 {
    ...
    public void testPut() throws IOException {
        ...
        fs.copyFromLocalFile(false, true, new Path("D:\\sunwukong.txt"), new Path("hdfs://hadoop100/xiyou/huaguoshan"));
    }
    ...
    public void testGet() throws IOException {
        ...
        //fs.copyToLocalFile(true, new Path("hdfs://hadoop100/xiyou/huaguoshan/"), new Path("D:\\"), true);
        fs.copyToLocalFile(false, new Path("hdfs://hadoop100/a.txt"), new Path("D:\\"), false);
    }
